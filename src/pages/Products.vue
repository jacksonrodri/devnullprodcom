            ...
            <div class="chart-content">
              ...
              <p class="body-1">
                ...
                <ul>
                  ...
                  <li><p>Accounts (created, active, deleted)</p></li>
                  <li><p>Transaction rates</p></li>
                  <li><p>Network fees and ledger close times</p></li>
                </ul>
                <br /><br />
...
.industry {
  ...
  & > div {
    ...
    & > a {
      ...
      &:after {
        content: url("~@/assets/imgs/arrow_forward_blue.svg");
        width: 24px;
        height: 24px;
        margin-left: 8px;
      }
